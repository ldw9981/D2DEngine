...
bool DemoApp::Initialize(UINT Width, UINT Height)
{
	...
	Animation.m_Frames.clear();
	Animation.m_Frames.push_back(FRAME_INFO(731, 1685, 805, 1775, 0.05f));
	Animation.m_Frames.push_back(FRAME_INFO(809, 1685, 890, 1772, 0.05f));
	Animation.m_Frames.push_back(FRAME_INFO(896, 1679, 955, 1773, 0.05f));
	Animation.m_Frames.push_back(FRAME_INFO(966, 1674, 1079, 1772, 0.05f));
	Animation.m_Frames.push_back(FRAME_INFO(1101, 1679, 1201, 1772, 0.05f));
    Animation.m_Frames.push_back(FRAME_INFO(1223, 1677, 1295, 1771, 0.05f));
    Animation.m_Frames.push_back(FRAME_INFO(1302, 1677, 1373, 1771, 0.05f));
    Animation.m_Frames.push_back(FRAME_INFO(1400, 1680, 1473, 1777, 0.05f));
	m_pAnimationAsset->m_Animations.push_back(Animation);
